...
import com.example.androidapp.shakyaruja.itsdc.elements.contactactivity.ScrollView1;
...
public class ContactActivity extends AppCompatActivity {
  ...
  protected void onCreate(Bundle savedInstanceState) {
    ...
    mMainLayout = (LinearLayout) findViewById(R.id.contact);
  ...
  public ContactActivity getContext() {
    return this;
  }
  ...
  private void setup() {
    ...
    ContactActivity.this.setSupportActionBar(appBar);
